    ...
    <div class="lang-switcher">
        <div class="lang-switcher__desktop">
            <div class="lang-switcher__selected" @click.stop="isOpen = !isOpen">
                ...
                <i v-html="arrowIcon" class="lang-switcher__icon" :class="{ open: isOpen }"></i>
            </div>
            <ul v-if="isOpen" class="lang-switcher__dropdown">
                <li v-for="lang in languages" :key="lang.code" class="lang-switcher__option"
                    ...
                    <i v-if="locale === lang.code" v-html="checkIcon" class="lang-switcher__check"></i>
                </li>
            </ul>
        </div>
        <div class="lang-switcher__mobile">
            <button v-for="lang in languages" :key="lang.code" class="lang-switcher__button"
                :class="{ active: locale === lang.code }" @click="switchLocale(lang.code)">
                {{ $t(lang.label) }}
            </button>
        </div>
    </div>
