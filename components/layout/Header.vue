...
<template>
  <header class="header" data-aos="fade-down" data-aos-duration="800">
    <div class="container header__inner">
      <a data-aos="fade-right" data-aos-delay="100" href="https://adsgram.ai">
        <img alt="AdsGram Logo" class="header__logo" src="@/assets/icons/logo.svg"/>
      </a>
  ...
  <div :class="{ open: isMobileMenuOpen }" class="mobile-menu">
    <div class="mobile-menu__header">
      <a href="/">
        <img alt="AdsGram Logo" class="mobile-menu__logo" src="@/assets/icons/logo.svg"/>
      </a>
